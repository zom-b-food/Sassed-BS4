				...
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="first-slide" src="../assets-bs/images/bg1.jpg" alt="First slide">
						...
						<div class="carousel-item">
							<img class="second-slide" src="../assets-bs/images/bg3.jpg" alt="Second slide">
						...
						<div class="carousel-item">
							<img class="third-slide" src="../assets-bs/images/bg4.jpg" alt="Third slide">
